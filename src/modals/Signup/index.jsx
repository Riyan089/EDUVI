                  ...
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                    ...
                    <div className="flex flex-col items-center justify-start">
                      <Input
                        ...
                        size="xs"
                      ></Input>
                      <div className="flex flex-row gap-2 items-center justify-center mt-[27px] w-[69%] md:w-full">
                      ...
                      <div className="flex flex-col items-start justify-start mt-8 w-full">
                        ...
                        <CheckBox
                          className="font-medium mt-[23px] text-base text-gray-900 text-left"
                        ...
                        ></CheckBox>
                        <Button
                          className="cursor-pointer font-medium min-w-[370px] mt-7 rounded-[10px] text-base text-center"
                          size="lg"
                        >
                          Sign Up
                        </Button>
                        <Text
                          className="md:ml-[0] ml-[74px] mt-8 text-base text-deep_purple-A200"
                          size="txtMetropolisMedium16DeeppurpleA200"
                        >
